...
public class KPSPublicSoapProxy implements external.mernis.ws.KPSPublicSoap {
  private String _endpoint = null;
  private external.mernis.ws.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new external.mernis.ws.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public external.mernis.ws.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
