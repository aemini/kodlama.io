...
package external.mernis.ws;

public class KPSPublicLocator extends org.apache.axis.client.Service implements external.mernis.ws.KPSPublic {
    ...
    public external.mernis.ws.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public external.mernis.ws.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            external.mernis.ws.KPSPublicSoapStub _stub = new external.mernis.ws.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (external.mernis.ws.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                external.mernis.ws.KPSPublicSoapStub _stub = new external.mernis.ws.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
